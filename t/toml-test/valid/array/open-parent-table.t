...
open my $fh, '<', "./t/toml-test/valid/array/open-parent-table.toml" or die $!;
...
is($actual, $expected1, 'array/open-parent-table - from_toml') or do{
  diag 'TOML INPUT:';
  diag "$toml";
...
ok(!$error, 'array/open-parent-table - to_toml - no errors')
  or diag $error;

is($reparsed, $expected1, 'array/open-parent-table - to_toml') or do{
