...
open my $fh, '<', "./t/toml-test/valid/array/array-subtables.toml" or die $!;
...
is($actual, $expected1, 'array/array-subtables - from_toml') or do{
  diag 'TOML INPUT:';
  diag "$toml";
...
ok(!$error, 'array/array-subtables - to_toml - no errors')
  or diag $error;

is($reparsed, $expected1, 'array/array-subtables - to_toml') or do{
