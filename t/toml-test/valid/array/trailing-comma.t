...
open my $fh, '<', "./t/toml-test/valid/array/trailing-comma.toml" or die $!;
...
is($actual, $expected1, 'array/trailing-comma - from_toml') or do{
  diag 'TOML INPUT:';
  diag "$toml";
...
ok(!$error, 'array/trailing-comma - to_toml - no errors')
  or diag $error;

is($reparsed, $expected1, 'array/trailing-comma - to_toml') or do{
