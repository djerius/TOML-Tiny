...
open my $fh, '<', "./t/toml-test/valid/inline-table/key-dotted-05.toml" or die $!;
...
is($actual, $expected1, 'inline-table/key-dotted-05 - from_toml') or do{
  diag 'TOML INPUT:';
  diag "$toml";
...
ok(!$error, 'inline-table/key-dotted-05 - to_toml - no errors')
  or diag $error;

is($reparsed, $expected1, 'inline-table/key-dotted-05 - to_toml') or do{
