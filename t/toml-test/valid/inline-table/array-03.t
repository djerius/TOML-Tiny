...
open my $fh, '<', "./t/toml-test/valid/inline-table/array-03.toml" or die $!;
...
is($actual, $expected1, 'inline-table/array-03 - from_toml') or do{
  diag 'TOML INPUT:';
  diag "$toml";
...
ok(!$error, 'inline-table/array-03 - to_toml - no errors')
  or diag $error;

is($reparsed, $expected1, 'inline-table/array-03 - to_toml') or do{
