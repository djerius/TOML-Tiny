...
open my $fh, '<', "./t/toml-test/valid/spec-1.0.0/array-0.toml" or die $!;
               ...
               "numbers" => [
                              ...
                              bless( {
                                       ...
                                       "code" => sub {
                                                     ...
                                                     require Math::BigFloat;
                                                     my $got = 'Math::BigFloat'->new($_);
                                                     'Math::BigFloat'->new('0.2')->beq($got);
                                                 },
                                       "name" => "Math::BigFloat->new(\"0.2\")->beq(\$_)",
                                       "operator" => "CODE(...)",
                                       "stringify_got" => 0
                                     }, 'Test2::Compare::Custom' ),
                              bless( {
                                       ...
                                       "code" => sub {
                                                     ...
                                                     require Math::BigFloat;
                                                     my $got = 'Math::BigFloat'->new($_);
                                                     'Math::BigFloat'->new('0.5')->beq($got);
                                                 },
                                       "name" => "Math::BigFloat->new(\"0.5\")->beq(\$_)",
                                       "operator" => "CODE(...)",
                                       "stringify_got" => 0
                                     }, 'Test2::Compare::Custom' ),
                              bless( {
...
is($actual, $expected1, 'spec-1.0.0/array-0 - from_toml') or do{
  diag 'TOML INPUT:';
  diag "$toml";
...
ok(!$error, 'spec-1.0.0/array-0 - to_toml - no errors')
  or diag $error;

is($reparsed, $expected1, 'spec-1.0.0/array-0 - to_toml') or do{
