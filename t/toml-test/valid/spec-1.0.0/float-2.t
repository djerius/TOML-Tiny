...
open my $fh, '<', "./t/toml-test/valid/spec-1.0.0/float-2.toml" or die $!;
...
is($actual, $expected1, 'spec-1.0.0/float-2 - from_toml') or do{
  diag 'TOML INPUT:';
  diag "$toml";
...
ok(!$error, 'spec-1.0.0/float-2 - to_toml - no errors')
  or diag $error;

is($reparsed, $expected1, 'spec-1.0.0/float-2 - to_toml') or do{
