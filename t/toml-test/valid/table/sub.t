...
open my $fh, '<', "./t/toml-test/valid/table/sub.toml" or die $!;
...
is($actual, $expected1, 'table/sub - from_toml') or do{
  diag 'TOML INPUT:';
  diag "$toml";
...
ok(!$error, 'table/sub - to_toml - no errors')
  or diag $error;

is($reparsed, $expected1, 'table/sub - to_toml') or do{
