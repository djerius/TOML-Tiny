...
open my $fh, '<', "./t/toml-test/valid/table/array-within-dotted.toml" or die $!;
...
is($actual, $expected1, 'table/array-within-dotted - from_toml') or do{
  diag 'TOML INPUT:';
  diag "$toml";
...
ok(!$error, 'table/array-within-dotted - to_toml - no errors')
  or diag $error;

is($reparsed, $expected1, 'table/array-within-dotted - to_toml') or do{
