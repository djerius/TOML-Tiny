...
open my $fh, '<', "./t/toml-test/valid/table/array-implicit-and-explicit-after.toml" or die $!;
...
is($actual, $expected1, 'table/array-implicit-and-explicit-after - from_toml') or do{
  diag 'TOML INPUT:';
  diag "$toml";
...
ok(!$error, 'table/array-implicit-and-explicit-after - to_toml - no errors')
  or diag $error;

is($reparsed, $expected1, 'table/array-implicit-and-explicit-after - to_toml') or do{
