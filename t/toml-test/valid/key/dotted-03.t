...
open my $fh, '<', "./t/toml-test/valid/key/dotted-03.toml" or die $!;
...
is($actual, $expected1, 'key/dotted-03 - from_toml') or do{
  diag 'TOML INPUT:';
  diag "$toml";
...
ok(!$error, 'key/dotted-03 - to_toml - no errors')
  or diag $error;

is($reparsed, $expected1, 'key/dotted-03 - to_toml') or do{
